...
plot = newpivot %>% 
  ...
  tab_style(style = cell_fill(color = "gray85"),locations = cells_body(columns = V1,rows = str_detect(V1,"NA")))%>% 
  tab_style(style = cell_fill(color = "gray85"),locations = cells_body(columns = V2,rows = str_detect(V2,"NA")))%>% 
  tab_style(style = cell_fill(color = "gray85"),locations = cells_body(columns = V3,rows = str_detect(V3,"NA")))%>% 
  tab_style(style = cell_fill(color = "gray85"),locations = cells_body(columns = V4,rows = str_detect(V4,"NA")))%>% 
  tab_style(style = cell_fill(color = "gray85"),locations = cells_body(columns = V5,rows = str_detect(V5,"NA")))%>% 
  tab_style(style = cell_fill(color = "gray85"),locations = cells_body(columns = V6,rows = str_detect(V6,"NA")))%>% 
  tab_style(style = cell_fill(color = "gray85"),locations = cells_body(columns = V7,rows = str_detect(V7,"NA")))%>% 
  tab_style(style = cell_fill(color = "gray85"),locations = cells_body(columns = V8,rows = str_detect(V8,"NA")))%>% 
  tab_style(style = cell_fill(color = "gray85"),locations = cells_body(columns = V9,rows = str_detect(V9,"NA")))%>% 
  tab_style(style = cell_fill(color = "gray85"),locations = cells_body(columns = V10,rows = str_detect(V10,"NA")))%>% 
  tab_style(style = cell_fill(color = "gray85"),locations = cells_body(columns = V11,rows = str_detect(V11,"NA")))%>% 
  tab_style(style = cell_fill(color = "gray85"),locations = cells_body(columns = V12,rows = str_detect(V12,"NA")))%>% 
  tab_style(style = cell_fill(color = "gray85"),locations = cells_body(columns = V13,rows = str_detect(V13,"NA")))%>% 
  tab_style(style = cell_fill(color = "gray85"),locations = cells_body(columns = V14,rows = str_detect(V14,"NA"))
            )%>% 
